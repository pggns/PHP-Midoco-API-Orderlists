...
class MidocoInvoiceDataListCriteriaType extends AbstractStructBase
{
     ...
     */
    public function __construct(array $orgUnits = [], ?string $debitorNo = null, ?string $receiptDateStart = null, ?string $receiptDateEnd = null, ?string $exportDateStart = null, ?string $exportDateEnd = null)
    {
        $this
