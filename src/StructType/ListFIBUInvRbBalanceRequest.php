...
class ListFIBUInvRbBalanceRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(array $orgUnits = [], ?int $orderNo = null, ?string $invoiceDateFrom = null, ?string $invoiceDateTo = null, ?string $excludedAccountsFrom = null, ?string $excludedAccountsTo = null, ?int $listType = null, ?bool $createCsvContent = null)
    {
        $this
