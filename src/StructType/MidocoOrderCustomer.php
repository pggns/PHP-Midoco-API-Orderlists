...
class MidocoOrderCustomer extends OrderCustomerDTO
{
     ...
     */
    public function __construct(array $midocoCommunication = [], ?\Pggns\MidocoApi\Orderlists\StructType\MidocoConsentCommunicationType $midocoConsentCustomer = null, ?bool $overrideExistingOrderCustomer = null, ?string $language = null)
    {
        $this
