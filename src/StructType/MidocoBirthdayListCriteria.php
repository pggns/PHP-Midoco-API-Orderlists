...
class MidocoBirthdayListCriteria extends AbstractStructBase
{
     ...
     * @param int $yearEnd
     */
    public function __construct(array $orgUnits = [], ?int $creationUserId = null, ?int $dayStart = null, ?int $dayEnd = null, ?int $monthStart = null, ?int $monthEnd = null, ?int $yearStart = null, ?int $yearEnd = null)
    {
        $this
