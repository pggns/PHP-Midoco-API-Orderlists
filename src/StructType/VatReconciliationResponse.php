...
class VatReconciliationResponse extends AbstractStructBase
{
     ...
     */
    protected array $MidocoVatReconciliation = [];
    /**
     ...
     */
    protected array $MidocoVatReconciliationSums = [];
    /**
     * The noOfResults
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     */
    public function __construct(array $midocoVatReconciliation = [], array $midocoVatReconciliationSums = [], ?int $noOfResults = null)
    {
        $this
     ...
     */
    public function setMidocoVatReconciliation(array $midocoVatReconciliation = []): self
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\VatReconciliationResponse
     */
    public function setMidocoVatReconciliationSums(array $midocoVatReconciliationSums = []): self
    {
        // validation for constraint: array
