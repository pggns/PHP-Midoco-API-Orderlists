...
class OpenErListResponse extends AbstractStructBase
{
     ...
     */
    protected array $midocoOpenErOutputList = [];
    /**
     ...
     */
    protected array $midocoOpenErListSums = [];
    /**
     ...
     */
    protected array $midocoOpenErListErrors = [];
    /**
     * The noOfResults
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     */
    public function __construct(array $midocoOpenErOutputList = [], array $midocoOpenErListSums = [], array $midocoOpenErListErrors = [], ?int $noOfResults = null)
    {
        $this
     ...
     */
    public function setMidocoOpenErOutputList(array $midocoOpenErOutputList = []): self
    {
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\OpenErListResponse
     */
    public function setMidocoOpenErListSums(array $midocoOpenErListSums = []): self
    {
        // validation for constraint: array
     ...
     * @return \Pggns\MidocoApi\Orderlists\StructType\OpenErListResponse
     */
    public function setMidocoOpenErListErrors(array $midocoOpenErListErrors = []): self
    {
        // validation for constraint: array
