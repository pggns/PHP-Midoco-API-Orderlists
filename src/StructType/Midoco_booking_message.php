...
class Midoco_booking_message extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Pggns\MidocoApi\Orderlists\StructType\Internal_command_configuration[]
     */
     ...
     * @param \Pggns\MidocoApi\Orderlists\StructType\Internal_command_configuration[] $internal_command_configuration
    ...
    public static function validateInternal_command_configurationForArrayConstraintFromSetInternal_command_configuration(?array $values = []): string
    {
        ...
        foreach ($values as $midoco_booking_messageInternal_command_configurationItem) {
            // validation for constraint: itemType
            if (!$midoco_booking_messageInternal_command_configurationItem instanceof \Pggns\MidocoApi\Orderlists\StructType\Internal_command_configuration) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The internal_command_configuration property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\Internal_command_configuration, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Orderlists\StructType\Internal_command_configuration $item
     * @return \Pggns\MidocoApi\Orderlists\StructType\Midoco_booking_message
     */
    public function addToInternal_command_configuration(\Pggns\MidocoApi\Orderlists\StructType\Internal_command_configuration $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Orderlists\StructType\Internal_command_configuration) {
            throw new InvalidArgumentException(sprintf('The internal_command_configuration property can only contain items of type \Pggns\MidocoApi\Orderlists\StructType\Internal_command_configuration, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
