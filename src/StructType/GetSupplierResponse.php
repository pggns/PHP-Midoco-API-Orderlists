...
class GetSupplierResponse extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Orderlists\StructType\MidocoSupplierType $midocoSupplier = null, ?\Pggns\MidocoApi\Orderlists\StructType\MidocoSupplierAddress $midocoSupplierAddress = null, array $midocoSupplierAccountAssign = [], array $midocoSupplierPaymentCondition = [])
    {
        $this
